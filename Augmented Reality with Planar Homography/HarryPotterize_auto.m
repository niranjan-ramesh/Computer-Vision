...
title("Display Warped image");
frame = getframe(warp_fig);
imwrite(frame2im(frame), "../results/Q4_6-Potterize_Warp_image.png");
...
frame = getframe(comp_fig);
imwrite(frame2im(frame), "../results/Q4_6-Potterize_Composite_image.png");
